...
object database {
  ...
  def createNewTable(): Unit = { // SQLite connection string
    ...
    val sql_array = new Array[String](4)
    ...
    sql_array(3) = "CREATE TABLE IF NOT EXISTS survey (" +
  ...
  def insert(): Unit = {
    val sql_array = new Array[String](20)
    ...
    sql_array(16) = "INSERT INTO survey(id_user,survey,response) VALUES(1,'Aime tu le poulet ?',1)"
    sql_array(17) = "INSERT INTO survey(id_user,survey,response) VALUES(3,'Aime tu le poulet ?',1)"
    sql_array(18) = "INSERT INTO survey(id_user,survey,response) VALUES(4,'Aime tu le poulet ?',0)"
    sql_array(19) = "INSERT INTO survey(id_user,survey,response) VALUES(5,'Aime tu le poulet ?',0)"
